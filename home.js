...
//CODE HERE
const formalNames = ['Andrew', 'Elizabeth', 'Conrad', 'James']

const greetUser = username => {
    return username.map(username => `Welcome back,' ${username}`)
}

const greetings = greetUser(formalNames)
...
function canWeDeliver(zipCode) {
    if (zipCode = deliveryAreaZipCodes) {
        ...
        console.log("Sorry, we can't deliver to that adress")
    }
}
...
// CODE HERE
const canWeDeliverTwo = [canWeDeliverTwo.includes(deliveryAreaZipCodes)];
...
const deals = [
    ...
    {
        titleTwo: 'Free Kids Meal with 2 Regular Entrees', 
        descTwo: '   This deal lasts until the end of March! '
    }
]
...
//CODE HERE
deals.descTwo = '    This deal lasts until the end of March!'
let newMonth = descTwo.replace('This deal lasts until the end of April!')
