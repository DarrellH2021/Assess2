...
Class Employee {
    ...
    getSchedule() {
        console.log($[this.empName] + 'works on' $[this.empshift])
    }
}
...
*/
let empOne = new Employee('Jess', 'weekday')
//CODE HERE
const jane = new Employee('jane', 'fridays');
//console.log(jane)
...
//CODE HERE
Class Manager {
    constructor(Employee, shifts, employees) {
